...
void write_color(std::ostream &out, color pixel_color)
{
    ...
    int ir = static_cast<int>(255 * interval(0.0, 0.999).clamp(r));
    int ig = static_cast<int>(255 * interval(0.0, 0.999).clamp(g));
    int ib = static_cast<int>(255 * interval(0.0, 0.999).clamp(b));
